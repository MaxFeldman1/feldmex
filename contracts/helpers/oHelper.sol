...
contract oHelper {
	...
	constructor (address _feldmexERC20HelperAddress) public {
	...
	function deploy(address _oracleAddress, address _underlyingAssetAddress, address _strikeAssetAddress) public {
		...
		optionsAddress[msg.sender][index] = address(new options(_oracleAddress, _underlyingAssetAddress, _strikeAssetAddress, feldmexERC20HelperAddress));
